...
public class NetCutTest2 extends FailOverBaseCase{
	...
	public void testFailover_01_cutoff_a1b1_a1b2_b1a2()
	{
		...
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float==1);
		...
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>0);
		log.error("Write data success on master cs!");
		datacnt2=getVerifySuccessful((String)csList.get(1));
		assertTrue("verify data failed!",datacnt2/FailOverBaseCase.put_count_float>0);
		log.error("Write data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>0);
		log.error("Write data success on client!");
		...
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>1);
		...
		datacnt1=getVerifySuccessful((String)csList.get(0));
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>0.9);
		log.error("Write data over on master cs!");
		datacnt2=getVerifySuccessful((String)csList.get(1));
		assertTrue("verify data failed!",datacnt2/FailOverBaseCase.put_count_float>0.9);
		log.error("Write data over on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>0.9);
		...
		log.error("Get data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>1.9);
		log.error("Get data success on client!");
	...
	public void testFailover_04_cutoff_a1b2_b1a2_a1b1()
	{
		...
		datacnt1=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>1.9);
		log.error("get data success on client!");
		datacnt1=getVerifySuccessful((String)csList.get(0));
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>0.9);
		log.error("get data success on master cs!");
	...
	public void testFailover_05_cutoff_b1a2_a1b1_a1b2()
	{
		...
		log.error("Write data success on master cs!");
		datacnt1=getVerifySuccessful((String)csList.get(1));
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>0.8);
		log.error("Write data success on slave cs!");
...
//		wait_tool_on_mac((String)csList.get(1));
		...
		datacnt1=getVerifySuccessful((String)csList.get(0));
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>0.6);
		log.error("Get data success on master cs!");
//		datacnt2=getVerifySuccessful((String)csList.get(1));
//		assertTrue("verify data failed!",datacnt2/FailOverBaseCase.put_count_float>=0);
//		log.error("Get data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>1.3);
		log.error("Get data success on client!");
...
//		log.error("Put data success on slave cs!");
		...
		datacnt1=getVerifySuccessful((String)csList.get(0));
		assertTrue("verify data failed!",datacnt1/FailOverBaseCase.put_count_float>1.5);
		log.error("Get data success on master cs!");
//		datacnt2=getVerifySuccessful((String)csList.get(1));
//		assertTrue("verify data failed!",datacnt2/FailOverBaseCase.put_count_float>0.9);
//		log.error("Get data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>2.2);
		log.error("Get data success on client!");
...
//		wait_tool_on_mac((String)csList.get(1));
	...
	public void testFailover_12_cutoff_a1b1_a1b2_b1a2_recover_b1a2_a1b2_a1b1()
	{
		...
		log.error("Put data success on master cs!");
		datacnt2=getVerifySuccessful((String)csList.get(1));
		assertTrue("verify data failed!",datacnt2/FailOverBaseCase.put_count_float>0.7);
		log.error("Put data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>0.6);
		log.error("Put data success on client!");
		...
		log.error("Get data success on slave cs!");
		datacnt3=getVerifySuccessful("local");
		assertTrue("verify data failed!",datacnt3/FailOverBaseCase.put_count_float>1.5);
		log.error("Get data success on client!");
