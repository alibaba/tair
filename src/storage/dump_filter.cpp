...
void dump_filter::set_parameter(uint32_t start_time, uint32_t end_time, int32_t area, const string &dir) {
...
bool dump_filter::do_dump(const data_entry &key, const data_entry &value, uint32_t area) {
